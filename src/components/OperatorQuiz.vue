...
export default {
  ...
  methods: {
    ...
    startQuiz() {
      ...
      this.answers = [];
      this.answers.push(methodsToUse(this.operandLeft, this.operandRight + 1));
      this.answers.push(methodsToUse(this.operandLeft + 1, this.operandRight));
      this.answers.push(
        methodsToUse(this.operandLeft + 1, this.operandRight + 1)
      );
      this.answers.push(methodsToUse(this.operandLeft - 1, this.operandRight));
      this.answers.push(methodsToUse(this.operandLeft, this.operandRight - 1));
